...
Before starting this chapter, make sure you have followed the steps in [Chapter 1](/chapter-1.md) to set up WeTravel on your local webserver. Navigate to https://www.we-travel.com to make sure that you have WeTravel running properly.
